  ...
  return (
    <div>
      <header className="header6">
        <p className="advisor">Advisor Brokerage Details</p>
        <div className="contnr">
          <div className="broker-cont">
            <div className="broker-circle-round">
              <svg
          ...
          <div className="broker-cont">
            <div className="broker-circle-round1">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
          ...
          <div className="broker-cont">
            <div className="broker-circle-round2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
        ...
        <div className="textContact">
          <p>
            Ready to start a conversation? Contact Jennifer Lynn Hall today.
          </p>
